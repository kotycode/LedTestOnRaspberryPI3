...
public class LedControl {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		final GpioPinDigitalOutput pin02 = gpio.provisionDigitalOutputPin(RaspiPin.GPIO_02,
				"PinLED", PinState.HIGH);
		final GpioPinDigitalOutput pin03 = gpio.provisionDigitalOutputPin(RaspiPin.GPIO_03,
				"PinLED", PinState.HIGH);
